...
| Materials | Specific weight $\gamma$ [ $\mathrm{kN} / \mathrm{m}^{3}$ ] |
| :--- | :--- |
| concrete (see EN 206) |  |
| lightweight |  |
| density class D1,0 | 8,0 to $10,0{ }^{\text {a b }}$ |
| density class D1,2 | 10,0 to $12,0{ }^{\text {a b }}$ |
| density class D1,4 | 12,0 to 14,0 ${ }^{\text {a b }}$ |
| density class D1,6 | 14,0 to $16,0{ }^{\text {a b }}$ |
| density class D1,8 | 16,0 to $18,0{ }^{\text {a b }}$ |
| density class D2,0 | 18,0 to 20,0 a b |
| normal weight | $24,0 \mathrm{ab}$ |
| heavy weight | $>26,0{ }^{\text {a b }}$ |
| mortar |  |
| cement mortar | 19,0 to 23,0 |
| gypsum mortar | 12,0 to 18,0 |
| lime-cement mortar | 18,0 to 20,0 |
| lime mortar | 12,0 to 18,0 |
| a Increase by $1 \mathrm{kN} / \mathrm{m}^{3}$ for normal percentage of reinforcing and pre-stressing steel <br> b Increase by $1 \mathrm{kN} / \mathrm{m}^{3}$ for unhardened concrete |  |
...
| Materials | Specific weight <br> $\gamma$ <br> [ $\mathrm{kN} / \mathrm{m}^{3}$ ] |
| :--- | :--- |
| other materials |  |
| glass, broken | 22,0 |
...
| infills for bridges |  |
| sand (dry) | 15,0 to 16,0 ${ }^{\text {a }}$ |
| ballast, gravel (loose) | 15,0 to 16,0 ${ }^{\text {a }}$ |
| hardcore | 18,5 to 19,5 |
| crushed slag | 13,5 to 14,5 ${ }^{\text {a }}$ |
...
| Elements | Weight per unit bed length ${ }^{\text {b }}$ c <br> $g_{\mathrm{k}}$ [kN/m] |
...
| NOTE The values for track are also applicable outside railway bridges. <br> a Given in other tables as stored materials <br> b Excludes an allowance for ballast <br> c Assumes a spacing of 600 mm |  |
...
| Materials | Specific weight $\gamma$ [ $\mathrm{kN} / \mathrm{m}^{3}$ ] | Angle of repose $\phi\left[{ }^{\circ}\right]$ |
| :--- | :--- | :--- |
| aggregates (see EN 206) |  | 30 |
| lightweight | 8,0 to 20,0 ${ }^{\text {a }}$ | 30 |
| normal | 20,0 to 30,0 | 30 |
| heavyweight | > 30,0 | 35 |
| gravel and sand, bulked | 15,0 to 20,0 | 30 |
| sand | 14,0 to 19,0 |  |
| blast furnace slag |  |  |
| lumps | 17,0 | 40 |
| granules | 12,0 | 30 |
| crushed foamed | 9,0 | 35 |
| brick sand, crushed brick, broken bricks | 1,5,0 | 35 |
...
| glue resins | 13,0 | - |
| water, fresh | 10,0 |  |
| a See table A. 1 for density classes of lightweight concrete |  |  |


Table A. 8 - Stored products - agricultural
| Products | Specific weight $\gamma\left[\mathrm{kN} / \mathrm{m}^{3}\right]$ | Angle of repose $\phi\left[{ }^{\circ}\right]$ |
| :--- | :--- | :--- |
| farmyard |  |  |
...
| :--- | :--- | :--- |
| grain |  |  |
| whole ( $\leq 14 \%$ moisture content unless indicated otherwise) | 7,8 | 30 |
| general | 7,0 | 30 |
| barley | 8,8 | - |
...
| Products | Specific weight $\gamma$ [ $\mathrm{kN} / \mathrm{m}^{3}$ ] | Angle of repose $\phi\left[{ }^{\circ}\right]$ |
| :--- | :--- | :--- |
...
| Products | Specific weight <br> $\gamma$ <br> $\left[\mathrm{kN} / \mathrm{m}^{3}\right]$ | Angle <br> of repose <br> $\phi\left[^{\circ}\right]$ |
| :--- | :---: | :---: |
| sugarbeet |  |  |
...
| Products | Specific weight $\gamma$ [ $\mathrm{kN} / \mathrm{m}^{3}$ ] |
| :--- | :--- |
| beverages |  |
| beer | 10,0 |
| milk | 10,0 |
| water, fresh | 10,0 |
| wine | 10,0 |
| natural oils | $\cdots \cdot, \cdots \cdot \ldots, \ldots, \ldots, \ldots$, |
| castor oil | 9,3 |
